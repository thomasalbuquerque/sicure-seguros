...
const insurances = [
  { title: 'Auto', icon: <FaTruckFront className='text-primary' />, link: '/seguro-automotivo' },
  { title: 'Residencial', icon: <IoHome className='text-primary' />, link: '/seguro-residencial' },
  {
    title: 'Empresarial',
    icon: <MdBusinessCenter className='text-primary' />,
    link: '/seguro-empresarial',
  },
  { title: 'Vida', icon: <FaHeartCirclePlus className='text-primary' />, link: '/seguro-de-vida' },
  {
    title: 'Aeronáutico (Casco)',
    icon: <FaPlaneDeparture className='text-primary' />,
    link: '/seguro-aeronautico-casco',
  },
  {
    title: 'Aeronáutico (R.E.T.A)',
    icon: <BsAirplaneFill className='text-primary' />,
    link: '/seguro-aeronautico-reta',
  },
  {
    title: 'Acidentes',
                ...
                <Menu.Item key={index}>
                  {({ active }) => (
                    ...
                    <Link href={insurance.link ?? '/'}>
                      <div className={classNames(active ? ' text-primary' : 'text-secondary', 'flex gap-2 px-4 py-2 text-sm items-center cursor-pointer')}>
                        {insurance.icon}
                        {insurance.title}
                        {/*</a> */}
                      </div>
